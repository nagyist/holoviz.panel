...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/wheels/bokeh-3.3.2-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.3.4/dist/wheels/panel-1.3.4-py3-none-any.whl', 'pyodide-http==0.2.1', 'holoviews', 'numpy', 'param', 'pyvista', 'scipy']
